...
rooms_desc = {
    'Living': living_desc,
    'Garden': garden_desc,
    'Kitchen': kitchen_desc,
    'Bedroom': bedroom_desc,
}
rooms_desc_map = {}
...
rooms_valid_acts = {
    'Living': living_valid_act,
    'Garden': garden_valid_act,
    'Kitchen': kitchen_valid_act,
    'Bedroom': bedroom_valid_act,
}
rooms_valid_objs = {
    'Living': living_valid_obj,
    'Garden': garden_valid_obj,
    'Kitchen': kitchen_valid_obj,
    'Bedroom': bedroom_valid_obj,
}
rooms_transit = {
    'Living': living_transit,
    'Garden': garden_transit,
    'Kitchen': kitchen_transit,
    'Bedroom': bedroom_transit,
}
...
def step_game(current_room_desc, current_quest_desc, action_index, object_index):
    ...
    if command_is_valid[current_room_index, action_index, object_index] == 1:
        ...
        if (actions[action_index] == quest_actions[quest_index]) and (
            ...
            if DEBUG:
                print(
                    'Finish quest: %s at Room %s with command %s %s'
                    % (
                        current_quest_desc,
                        current_room_desc,
        ...
        next_room_dist = transit_matrix[
            current_room_index, action_index, object_index, :
        ]
